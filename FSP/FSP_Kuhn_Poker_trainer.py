  ...
  def train(self, n, m, memory_size_rl, memory_size_sl, wandb_save, rl_algo, sl_algo, pseudo_code):
    ...
    for iteration_t in tqdm(range(1, int(self.train_iterations//self.episode_num_for_1_iteration)+1)):
      ...
      if(iteration_t%10 == 0):
        ...
        difference = 0
        for key in result_dict_avg:
          difference = difference +  abs(nash_equilibrium[key][0] - result_dict_avg[key][0])
      ...
      # if(iteration_t == 20 or iteration_t == 100 or iteration_t == 400):
      #   print("Results for iteration {} are:".format(iteration_t))
      #   result_dict_avg = {}
      #   for key, value in sorted(self.avg_strategy.items()):
      #     result_dict_avg[key] = value
      ...
      #   result_dict_br = {}
      #   for key, value in sorted(self.best_response_strategy.items()):
